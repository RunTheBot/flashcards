...
export function AIFlashcardsClient() {
	...
	const handleGenerate = async () => {
		...
		try {
			...
			toast.success(
				`Successfully created "${deckName}" with ${result.cardsGenerated} flashcards!`,
			);
				...
				<div className="mx-auto flex max-w-4xl flex-col gap-8">
					...
					<div className="flex flex-col gap-2">
						...
						<p className="text-muted-foreground">
							Create comprehensive flashcard decks using advanced AI models.
							Describe any topic and get high-quality study materials instantly.
						</p>
					</div>
...
'The causes and major events of World War II, including key battles, political figures, and the impact on different countries. Cover both European and Pacific theaters.'"
										...
										<p className="text-muted-foreground text-xs">
											Tip: Be specific about what aspects you want to focus on.
											The AI will automatically generate an appropriate deck
											name.
										</p>
									</div>
									...
									>
										{isGenerating ? (
											<>
												...
												Creating deck and generating{" "}
												{cardCount === "auto" ? "optimal number of" : cardCount}{" "}
												flashcards...
											</>
										) : (
											<>
												...
												{cardCount === "auto" ? "Optimal" : cardCount}{" "}
												Flashcards
											</>
										)}
									</Button>
									...
									{aiSettings.isLoading ? (
										...
										<>
											<div className="space-y-3">
												<Label className="font-medium text-sm">AI Models</Label>
												<div className="space-y-3">
